...
export class scenario
{
    ...
    constructor()
    {
        ...
        this.Menu_btn=element(by.xpath('//*[@name="Open the menu"]'));
   ...
   Scenario_verify_first_module()
    {
        ...
        this.Start_btn.click().then(function(){browser.sleep(15000)});
    ...
    Scenario_being_at_your_best()
    {
        ...
        this.Continue_Btn.click().then(function()
        {
            ...
            browser.sleep(15000)
            var el =  element(by.tagName('video'));
            browser.executeScript('arguments[0].currentTime=94;', el);
            browser.sleep(10000);
            browser.sleep(15000)
            var el =  element(by.tagName('video'));
            browser.executeScript('arguments[0].currentTime=115;', el);
            browser.sleep(10000);
    ...
    {
        //this 3 lines is for saperated script and dont forget to uncomment this.continue 
